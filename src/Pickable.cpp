...
//class to extend pickable and overloads the function to heal the wearer
...
bool LightningBolt::use(Actor *owner, Actor *wearer){
	...
	if(!closestMonster){
		engine.gui->message(TCODColor::lightGrey, "No enemey is close enough to strike.");
		return false; 
	}
	...
	//call father's class use to consume item and remove it from the inventory
	return Pickable::use(owner, wearer);
